                ...
                <td valign="top" style="padding: 0px 0px 0px 15px;">
                    ...
                    <div class="userp_info">
						<h2>Пользователь {usertitle}</h2>
							...
							<ul>
								<li>Полное имя:<span>{fullname}</span></li>
								<li>Группа:<span>{status}</span></li>
								<li>Дата регистрации:<span>{registration}</span></li>
									                      <ul>
	                        <li><a href="">Сообщения</a></li>
	                        <li>{edituser}</li>
	                        <li><a href="/index.php?action=logout"><b>Выход</b></a></li>
	                      </ul>
							</ul>
						</div>
						<br>
